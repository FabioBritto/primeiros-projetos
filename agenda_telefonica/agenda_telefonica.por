programa
{
	...
	logico repetir = falso //necessário para a função escolha_contato()
	...
	funcao menuInicial()
	{
		...
		logico executarPrograma = verdadeiro, iniciar = verdadeiro
	...
	funcao limpar_memoria(cadeia matriz_a_ser_limpa[][])
	{
		...
		enquanto(matriz_a_ser_limpa[linha][0] != "")
		{
			// Limpa os registros
	...
	funcao escolha_contato()
	{
		...
		faca
		{
			...
			}enquanto(resp_caracter != 'N' e resp_caracter != 'B' e resp_caracter != 'C' e tipo.cadeia_e_inteiro(resp, 10) == falso) 
 ...
 * 
 * @POSICAO-CURSOR = 19340; 
 * @DOBRAMENTO-CODIGO = [29, 43, 210, 268, 283, 319, 448, 532, 673, 707, 743, 775];
 * @PONTOS-DE-PARADA = ;
